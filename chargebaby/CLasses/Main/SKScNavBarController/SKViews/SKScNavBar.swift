    ...
    var setViewWithItemIndex:Int {
        set{
            ...
            UIView.animate(withDuration: 0.2, animations: { () -> Void in
                ...
                itemBtn.setTitleColor(UIColor.blue, for: UIControlState())
...
//        setShadowForView(self, shadowRadius: 10.0, shadowOpacity: 10.0)
    ...
    fileprivate func getScNavContentAddScNavBarItemsWithItemsWidth(_ widths:NSArray) -> CGFloat {
        ...
        for index in 0 ..< itemsTitles.count {
            ...
            button.addTarget(self, action: #selector(SKScNavBar.itemsBtnAction(_:)), for:
...
//            let fValue:CGFloat = size.width + 40
            let fValue:CGFloat = self.frame.size.width / 2.0
